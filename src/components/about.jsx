                                ...
                                <div className="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                                    <div className="col-md-12">
                                        <div className="about-desc">
                                            ...
                                            <p><strong>Holandas soy carlos petit</strong> Lo que hacemos es el testimonio de quienes somos. Las personas pueden estar involucradas o no, pero para mí es una cuestión de respeto por los demás. No involucrarse en el trabajo es simplemente un delito.</p>
